        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-5 gap-6">
            {shields.map((shield, index) => (
              <div key={shield.title} className="text-center">
          ...
          <div className="mt-12 p-8 rounded-2xl text-center" style={{ background: 'rgba(255, 255, 255, 0.05)', border: '1px solid rgba(242, 183, 5, 0.2)' }}>
